...
///
/// 处理高频、实时性要求高的消息类型，包括：
/// - 正在输入状态（TYPING_STATUS）
/// - 通话邀请/接受/取消/拒绝（CALL_INVITE, CALL_ACCEPT, CALL_CANCEL, CALL_REJECT）
/// - 通话信令（CALL_CANDIDATE, CALL_MEDIA_CHANGE）
/// - 消息撤回（MSG_REVOKE）
/// - 系统踢人（SYSTEM_KICK）
///
/// 采用 keepAlive 模式确保全局共享，自动管理定时器和状态清理。
